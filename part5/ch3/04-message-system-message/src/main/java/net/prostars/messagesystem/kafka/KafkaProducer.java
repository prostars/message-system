...
public class KafkaProducer {
  ...
  public void sendMessageUsingPartitionKey(
      String topic, ChannelId channelId, UserId userId, RecordInterface recordInterface) {
    ...
    jsonUtil
        ...
        .ifPresent(
            record ->
                kafkaTemplate
                    .send(topic, partitionKey, record)
  ...
  private BiConsumer<SendResult<String, String>, Throwable> logResult(
      String topic, String record, String partitionKey) {
