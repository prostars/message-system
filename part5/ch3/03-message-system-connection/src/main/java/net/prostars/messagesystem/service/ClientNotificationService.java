...
public class ClientNotificationService {
  ...
  public ClientNotificationService(
      WebSocketSessionManager webSocketSessionManager, PushService pushService, JsonUtil jsonUtil) {
  ...
  private void sendPayload(
      WebSocketSession session, BaseMessage message, RecordInterface recordInterface) {
